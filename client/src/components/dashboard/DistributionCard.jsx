const DistributionCard = ({ distribution, cardStyle = {} }) => {
  ...
  return (
    <div className="bg-[#dbeafe] rounded-2xl p-6 shadow h-[300px] flex flex-col transition-all duration-300 ease-in-out hover:-translate-y-[5px] hover:shadow-lg" style={cardStyle}>
      <h3 className="text-lg font-semibold text-[#333333] mb-4 flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#f59e0b]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="space-y-5 flex-grow">
        <div>
          <div className="flex justify-between mb-1">
            ...
            <span className="text-sm font-medium text-[#10b981]">{easyPercentage}%</span>
          </div>
        ...
        <div>
          <div className="flex justify-between mb-1">
            <span className="text-sm font-medium text-[#f59e0b] flex items-center">
              <span className="w-2 h-2 rounded-full bg-[#f59e0b] mr-1.5"></span>
              Medium ({distribution.medium})
            </span>
            <span className="text-sm font-medium text-[#f59e0b]">{mediumPercentage}%</span>
          </div>
          <div className="w-full bg-[#94a3b8] rounded-full h-2 overflow-hidden">
            <div 
        ...
        <div>
          <div className="flex justify-between mb-1">
            <span className="text-sm font-medium text-[#ef4444] flex items-center">
              <span className="w-2 h-2 rounded-full bg-[#ef4444] mr-1.5"></span>
              Hard ({distribution.hard})
            </span>
            <span className="text-sm font-medium text-[#ef4444]">{hardPercentage}%</span>
          </div>
          <div className="w-full bg-[#94a3b8] rounded-full h-2 overflow-hidden">
            <div 
      ...
      <div className="mt-4 flex justify-between items-center">
        <span className="text-sm text-[#333333]">Total Problems</span>
