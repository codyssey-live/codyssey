  ...
  return (
    <div className="bg-[#dbeafe] rounded-2xl p-6 shadow h-[300px] flex flex-col transition-all duration-300 ease-in-out hover:-translate-y-[5px] hover:shadow-lg" style={cardStyle}>
      ...
      <div className="space-y-5 flex-grow">
        <div>
          <div className="flex justify-between mb-1">
            ...
            <span className="text-sm font-medium text-[#f59e0b]">{leetcodePercentage}%</span>
          </div>
        ...
        <div>
          <div className="flex justify-between mb-1">
            ...
            <span className="text-sm font-medium text-[#ef4444]">{codeforcesPercentage}%</span>
          </div>
          <div className="w-full bg-[#94a3b8] rounded-full h-2 overflow-hidden">
            <div 
        ...
        <div>
          <div className="flex justify-between mb-1">
            ...
            <span className="text-sm font-medium text-[#10b981]">{hackerrankPercentage}%</span>
          </div>
          <div className="w-full bg-[#94a3b8] rounded-full h-2 overflow-hidden">
            <div 
      ...
      <div className="mt-4 flex justify-between items-center">
        <span className="text-sm text-[#333333]">Total Submissions</span>
