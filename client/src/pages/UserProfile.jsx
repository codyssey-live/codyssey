...
const UserProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-[#E8F1F7] text-gray-800">
      ...
      <main className="container mx-auto px-4 py-8 md:flex md:space-x-6">
        ...
        <aside className="mb-6 md:mb-0 md:w-1/3 flex-shrink-0">
          ...
          <div className="bg-[#dbeafe] rounded-lg overflow-hidden shadow-sm">
            {/* Gradient Header */}
            <div className="h-32 bg-gradient-to-r from-[#c2d9f0] via-[#a7c7e7] to-[#8fb6de] relative">
              {/* Avatar */}
              <div className="w-24 h-24 bg-white rounded-full absolute left-1/2 transform -translate-x-1/2 -bottom-12 border-4 border-white flex items-center justify-center">
                <span className="text-4xl font-medium text-[#2a4365]">{user.avatarLetter}</span>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#dbeafe] rounded-lg shadow-sm p-6">
                ...
                <div className="flex h-2 gap-1 mt-1 mb-4">
                  <div className="h-full bg-[#94c3d2] rounded-full flex-1"></div>
                  <div className="h-full bg-gray-300 rounded-full flex-1"></div>
                  <div className="h-full bg-gray-300 rounded-full flex-1"></div>
                  <div className="h-full bg-gray-300 rounded-full flex-1"></div>
                  <div className="h-full bg-gray-300 rounded-full flex-1"></div>
                </div>
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-600">Add a photo to complete your profile. 
                    <button onClick={() => openModal('photo')} className="text-[#94c3d2] ml-1 hover:underline">
      ...
      {/* Modals - Keeping the photo upload modal */}
      {activeModal === 'photo' && (
        <Modal title="Upload Profile Photo" onClose={closeModal}>
          <div className="text-center">
            ...
            <label 
              ...
              className="px-4 py-2 bg-[#94c3d2] text-white rounded-md cursor-pointer hover:bg-[#7ba9b8] text-sm font-medium inline-block"
            >
              Choose a file
            </label>
          </div>
